...
def first_page():
    ...
    This Virtual Teaching Assistant provides answers based on AI 504 course materials, syllabus, and class transcriptions.
    
    **Important Notice:**
    - This tool is exclusively for the AI504 course. **Do not** use it for any other purposes.
    - There is a rate limit on api usage. Please be mindful of your usage to ensure that all students have an equal opportunity to benefit from this tool.
    ...
    st.markdown("""
    **Contact Info:**
    - If you have any questions or need assistance, please contact: jiyoun.kim@kaist.ac.kr
