...
SYSTEM_PROMPT = (
    ...
    "2nd week, 9/9 (Tuesday), Basic Machine Learning + Scikit-learn, 9/11 (Thursday), Basic Machine Learning + Scikit-learn Practice Session\n"
    ...
    "8th week, 10/21 (Tuesday), Project 1: Image Synthesis, 10/23 (Thursday) No Class\n"
...
def get_conversational_rag(history_retriever_chain):
  ...
  llm = ChatOpenAI(model = "gpt-5-nano", temperature = 0, verbosity="medium", reasoning_effort="medium", streaming=True)
