...
SYSTEM_PROMPT = (
    ...
    "4th week, 9/23 (Tuesday), Autoencoders (& Denoising Autoencoders)(https://www.youtube.com/watch?v=qwQD4dmQSXY), 9/25 (Thursday), Autoencoders (& Denoising Autoencoders) Practice Session(https://www.youtube.com/watch?v=39NEFxSZ8XE)\n"
    "5th week, 9/30 (Tuesday), Variational Autoencoders(https://www.youtube.com/watch?v=xKQs79xtg2M), 10/2 (Thursday), Variational Autoencoders Practice Session(https://www.youtube.com/watch?v=YMmJSIhMzGU)\n"
